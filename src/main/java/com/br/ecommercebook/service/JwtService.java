...
public class JwtService {
  ...
  public boolean isUserAdmin(String token, UserDetails userDetails) {
  ...
  public boolean isTokenValid(String token, UserDetails userDetails) {
    ...
    var userDetailsEmail = userDetails.getUsername();
    var isExpired = this.isTokenExpired(token);
    
    return userDetailsEmail.equals(userEmail) && !isExpired;
}
